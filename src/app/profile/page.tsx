    ...
    <div className="min-h-screen bg-muted pb-24 md:pb-8">
      ...
      <div className="max-w-lg mx-auto px-4 py-6">
        <motion.div
          ...
          className="bg-card rounded-2xl overflow-hidden shadow-sm mb-4 border border-border"
        >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="w-full bg-card text-destructive border-2 border-destructive py-4 px-6 rounded-xl font-semibold flex items-center justify-center gap-2 shadow-sm hover:bg-destructive/5 transition-colors"
        >
          <LogOut size={20} />
          Déconnexion
        </motion.button>
