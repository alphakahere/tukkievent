      ...
      <header className="bg-white border-b border-gray-100 px-4 pt-12 pb-4 sticky top-0 z-40 md:hidden">
        <div className="max-w-lg mx-auto">
          <div className="flex items-center justify-between">
            ...
            {unreadCount > 0 && (
              <button type="button" onClick={markAllAsRead} className="flex items-center gap-1.5 text-sm text-primary font-semibold hover:opacity-80">
          ...
          <div className="flex-1">
            ...
            {notifications.length === 0 ? (
              <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="text-center py-16">
                ...
                <p className="text-base font-semibold text-gray-900 mb-1">Aucune notification</p>
                <p className="text-sm text-gray-500">Vos notifications apparaîtront ici</p>
              </motion.div>
            ) : (
              <>
